...
# BUG: In Linux the syntax above are not working, because a error of string
# conversions, Path have conversion rules described in $env.nu. But with this
# standart function works.
use std "path add"
